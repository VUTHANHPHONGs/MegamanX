...
public abstract class ParticularObject_1 extends GameObject_1{
    ...
    public ParticularObject_1(float x, float y, float width, float height, float mass, int blood, GameWorld_1 gameWorld){
