...
public class MegaMan_1 extends Human_1 {
    ...
    public MegaMan_1(float x, float y, GameWorld_1 gameWorld) {
    ...
    public void specialAttack(){
        if(!isShooting && !getIsDicking()){
            ...
            Bullet_1 bullet = new SpecialBullet_1(getPosX(), getPosY(), getGameWorld());
            if(getDirection() == LEFT_DIR) {
                bullet.setSpeedX(-10);
    ...
    public void attack() {
        ...
        if(!isShooting && !getIsDicking()){
            ...
            Bullet_1 bullet = new BlueFire_1(getPosX(), getPosY(), getGameWorld());
            if(getDirection() == LEFT_DIR) {
                bullet.setSpeedX(-10);
                bullet.setPosX(bullet.getPosX() - 40);
                if(getSpeedX() != 0 && getSpeedY() == 0){
