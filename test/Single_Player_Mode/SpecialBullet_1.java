 ...
 * @author Admin
 */
public class SpecialBullet_1 extends Bullet_1{
    private Animation forwardBulletAnim,backBulletAnim;

    public SpecialBullet_1(float x, float y, GameWorld_1 gameWorld) {
        super(x, y, 60, 30, 1.0f, 100, gameWorld);
        forwardBulletAnim = CacheDataLoader.getInstance().getAnimation("dandacbiet");
        backBulletAnim = CacheDataLoader.getInstance().getAnimation("dandacbiet");
        //dao_nguoc_animation
