 ...
 * @author Admin
 */
public class RobotR_1  extends ParticularObject_1{
    ...
    public RobotR_1(float x, float y, GameWorld_1 gameWorld) {
    ...
    public void attack() {  
       ...
       // shooting.play();
        Bullet_1 bullet = new RobotRBullet_1(getPosX(), getPosY(), getGameWorld());
