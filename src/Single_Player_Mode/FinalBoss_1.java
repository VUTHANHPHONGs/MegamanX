 ...
 * @author Admin
 */
public class FinalBoss_1 extends Human_1{
    ...
    public FinalBoss_1(float x, float y, GameWorld_1 gameWorld) {
    ...
    public void Update(){
        ...
        if(!attackType[attackIndex].equals("NONE")){
            if(attackType[attackIndex].equals("shooting")){
                ...
                Bullet_1 bullet = new RockeBullet_1(getPosX(), getPosY() - 50, getGameWorld());
